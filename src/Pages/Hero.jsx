...
function Hero() {
  return (
    <main className='flex mb-5 mt-5 md:h-[80vh] bg-gradient-to-r from-[#fcefce] to-[#e0f7f3] md:flex-row flex-col py-10 md:py-0 gap-10 md:gap-0 h-auto px-10 md:px-0  items-center justify-evenly'>
      <div>
