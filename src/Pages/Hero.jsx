...
function Hero() {
  return (
    <main className='flex md:h-[80vh] md:flex-row flex-col py-10 md:py-0 gap-10 md:gap-0 h-auto px-10 md:px-0  items-center justify-evenly'>
      <div>
      ...
      <div><img className='md:h-[80vh]' src="./heroimg.png" alt="" /></div>
    </main>
  )
}
