...
function NavBar(){
    ...
    return(
        ...
        isScrolled ? 'bg-gray-900 text-white' : 'md:bg-transparent bg-gray-900 text-white md:text-black'
                ...
                <nav className="flex justify-between relative items-center md:justify-around mt-5">
                    <div>
                    ...
                    <div className={`md:block ${!isOpen?"block":"hidden"} h-screen md:h-auto absolute bg-gray-900 md:bg-transparent text-white md:text-inherit top-24 md:top-auto md:relative md:m-auto -right-5 min-w-72 md:w-auto `}>
                        <ul className="flex flex-col md:flex-row px-5 py-5 gap-5">
                           ...
                           <NavLink to="/classes" className={({isActive})=>isActive?`text-primary`:`hover:text-primary`}> <li className="cursor-pointer">Classes</li></NavLink>
                           <div className="relative group">
                            ...
                            <div className="hidden relative md:absolute bg-secondary w-40  py-5  group-hover:block">
                              ...
                              <Link  to="/pages/testimonials"><div className="w-full py-2 px-2 hover:bg-gray-900 hover:text-white break-keep">Testimonials</div></Link>
                            </div>
                           </div>
                    ...
                    <div className="block md:hidden">
                      ...
                      {
                        !isOpen?<i className="text-3xl ri-close-large-line"></i>:<i className="ri-menu-line text-3xl"></i>
                      }
                    </div>
